...
model = tf.keras.models.load_model('DetectPneumonia_FINAL.h5')
...
st.write("This is a simple image classification web app to predict pneumonia through chest x-ray images.")
